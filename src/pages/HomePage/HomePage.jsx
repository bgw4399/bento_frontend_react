          ...
          <div className="mt-12 grid grid-cols-1 gap-8 md:grid-cols-3">
            <Link to="/cohort" className="group">
              <div className="h-full rounded-lg border border-gray-100 bg-white p-6 shadow-md transition-shadow hover:shadow-lg">
                ...
                <p className="text-gray-600">
                  Create and manage cohorts with an intuitive interface. Define
                  inclusion/exclusion criteria and build complex patient groups.
                </p>
              </div>
            </Link>
            ...
            <Link to="/cohort" className="group">
              <div className="h-full rounded-lg border border-gray-100 bg-white p-6 shadow-md transition-shadow hover:shadow-lg">
                ...
                <p className="text-gray-600">
                  Browse and analyze your Common Data Model (CDM) data. Explore
                  concept sets and understand your data structure.
                </p>
              </div>
            </Link>
            ...
            <Link to="/custom-chart" className="group">
              <div className="h-full rounded-lg border border-gray-100 bg-white p-6 shadow-md transition-shadow hover:shadow-lg">
                ...
                <p className="text-gray-600">
                  Create and manage custom charts with an intuitive interface.
                  Visualize and compare medical data across different cohorts,
                  and export chart results as images.
                </p>
              </div>
            </Link>
          </div>
